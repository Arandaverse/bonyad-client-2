...
export const UIButton: (
  props: ButtonProperties & RefAttributes<ComponentInternals>
  ...
  (
    ...
    return (
      <Container
        ...
        backgroundOpacity={disabled ? 0.2 : selected ? 1 : platter ? 0.15 : 0}
        hover={{
          backgroundOpacity: disabled ? 0.2 : selected ? 1 : 0.2,
        }}
        ref={ref}
        {...props}
      >
        <DefaultProperties
          color={selected && !disabled ? colors.text : colors.text}
